/**
 * Web Page to Figma JSON Extractor
 * 
 * This script extracts HTML/CSS from a webpage and converts it to the JSON format
 * compatible with the Code to Figma plugin.
 * 
 * Usage:
 * 1. Install dependencies: npm install puppeteer
 * 2. Run: node scripts/extract-web-page.js <url>
 * 
 * Example:
 * node scripts/extract-web-page.js https://example.com
 * 
 * Or use the interactive function in your browser console
 */
...
/**
 * Browser-based extraction function
 * Run this in your browser's console on any webpage
 */
...
console.log('Web Page to Figma JSON Extractor');
console.log('='.repeat(70));
console.log('');
console.log('🌐 BROWSER CONSOLE METHOD (Recommended)');
console.log('-'.repeat(70));
console.log('1. Open the webpage you want to extract in your browser');
console.log('2. Open Developer Tools (F12 or Cmd+Option+I)');
console.log('3. Go to the Console tab');
console.log('4. Copy and paste the extraction code below:');
console.log('');
console.log(browserExtractor);
console.log('');
console.log('5. Press Enter to run');
console.log('6. Enter a CSS selector when prompted (e.g., ".hero", "#main-card")');
console.log('7. The JSON will be automatically copied to your clipboard!');
console.log('8. Paste it into the Code to Figma plugin');
console.log('');
console.log('='.repeat(70));
console.log('');
console.log('💡 TIP: Add class="selected-for-figma" to any element');
console.log('   and it will be extracted automatically without prompting!');
console.log('');
console.log('='.repeat(70));

// Save the browser extractor to a separate file for easy access
const extractorPath = path.join(__dirname, 'web-extractor-browser.js');
fs.writeFileSync(extractorPath, browserExtractor, 'utf8');
console.log('');
console.log(`✅ Browser extractor saved to: ${extractorPath}`);
console.log('   You can also load this file directly in the browser!');
console.log('');
